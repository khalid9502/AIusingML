...
{
    public partial class ClassifyInterested : Form
    {
        ...
        public ClassifyInterested(string loginID, int appID)
        {
            LoginID = loginID;
            AppID = appID;

            Arithmetic = new Arithmetic();
            Connector = new DBConnector(LoginID, 3);
        ...
        private void ClassifyInterested_Load(object sender, EventArgs e)
        {
            //load customer Details in in dgvcustomers
            dgvCustomersDetails.Rows.Clear();

            Connector.CustomerLoad_ML_Interested(AppID, DataSet, TrainingData);
        ...
        private void loosingInterestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ClassifyLoosingInterest cli = new ClassifyLoosingInterest(LoginID, AppID);
            cli.Show();
        }
    }
}
